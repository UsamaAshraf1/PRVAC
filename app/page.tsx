...
import { Building2, GraduationCap, Landmark, Rocket, TrendingUp } from "lucide-react"
      ...
      <main className="mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {sectors.map((sector) => {
            ...
            return (
              <Link
                key={sector.id}
                href={`/questionnaire/${sector.id}`}
                className="group block"
              >
                <Card className={`h-full transition-all duration-200 ${sector.hoverColor} border-2`}>
                  <CardHeader>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="font-medium">{sector.questions}</span>
                      </div>
        ...
        <div className="mt-12 rounded-lg border bg-muted/30 p-6">
          ...
          <p className="mt-2 text-sm text-muted-foreground text-pretty">
            ...
            All data is collected anonymously and your progress is saved automatically so you can return 
            to complete the questionnaire at any time.
          </p>
        </div>
      </main>
